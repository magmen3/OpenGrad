...
function SWEP:DrawWeaponSelection( x, y, wide, tall, alpha )
	if !IsValid(DrawModel) then
		DrawModel = ClientsideModel( "models/jmod/explosives/grenades/flashbang/flashbang.mdl", RENDER_GROUP_OPAQUE_ENTITY );
		DrawModel:SetNoDraw( true );
	else
		DrawModel:SetModel( "models/jmod/explosives/grenades/flashbang/flashbang.mdl" )
...
function SWEP:Throw()
	...
	function Throw()
		if SERVER then
			...
			phys:SetVelocity(self:GetOwner():GetVelocity() + self:GetOwner():GetAimVector() * 1050)
