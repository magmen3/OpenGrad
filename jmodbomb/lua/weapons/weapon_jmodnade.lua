...
function SWEP:DrawWeaponSelection( x, y, wide, tall, alpha )
	if !IsValid(DrawModel) then
		DrawModel = ClientsideModel( "models/jmod/explosives/grenades/fragnade/w_fragjade.mdl", RENDER_GROUP_OPAQUE_ENTITY );
		DrawModel:SetNoDraw( true );
	else
		DrawModel:SetModel( "models/jmod/explosives/grenades/fragnade/w_fragjade.mdl" )
